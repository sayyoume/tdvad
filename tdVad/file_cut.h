...
public:
    ...
    int add_changed(struct cut_info* cut, int is_active);
    int add_continued(struct cut_info* cut, int is_active);
    int cut_frame(struct cut_info* cut, int last_frame, int force);
    int cut_write_file(struct cut_info* cut, int frames);
