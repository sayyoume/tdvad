    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 9:
				...
				else if (_tcsicmp(pstrClass, DUI_CTR_IMAGEEX) == 0)            pControl = new CImageExUI;
                break;
            case 10:
			...
			case 11:
				...
				break;
            case 12:
                if (_tcsicmp(pstrClass, DUI_CTR_HEADSELECT) == 0)			  pControl = new CHeadSelectUI;
                break;
            case 14:
